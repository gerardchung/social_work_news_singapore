...
# ==========================
    # Aim of files:
    # Section A: Load HTML and converts it to dataframe
        # Using tm.plugin.factiva package to load and convert to Vcorpus
        # corpus and convert functions from quanteda will convert Vcorpus to copus and dataframe
        # Each dataframe will be saved in "source_data_factiva/extracted_factiva"
    # Section B: Append all the dataframes together
    # Section C: Save as a dataframe 
...
# Section B: Append the dataframes into one
###################################################
...
# Section C: Load HTML and converts it to dataframe
###################################################
